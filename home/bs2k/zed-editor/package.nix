...
rustPlatform.buildRustPackage (finalAttrs: {
  ...
  src = fetchFromGitHub {
    ...
    hash = "sha256-eOGl6ptE9LG16z/POAHg66UPu8T97hYI4IvFSnW2D+o=";
  };
  ...
  cargoDeps = rustPlatform.fetchCargoVendor {
    ...
    postBuild = ''
      rm -r $out/git/724d75eb3deebefe83f2a7381a45d4fac6eda383/candle-book
    '';
    hash = "sha256-rdRa26vYQVlEqFGfdGDk7eLbCNb4mzL9Fy5iRPXUtgo=";
  };
