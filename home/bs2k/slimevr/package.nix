...
rustPlatform.buildRustPackage rec {
  ...
  src = fetchFromGitHub {
    ...
    repo = "SlimeVR-Server";
    rev = "v${version}";
    hash = "sha256-sJ18FcXoNyUx/+sDjM9Nx2MhIQ9d2ggbjtN+yO3ini8=";
    # solarxr
  ...
  pnpmDeps = pnpm_9.fetchDeps {
    ...
    inherit version src;
    hash = "sha256-rGuz10Z6LcyBfjvYfAbbrRMouzJ/3a8cRefJjD4KO9o=";
  };
  ...
  preBuild = ''
    pnpm --filter solarxr-protocol install --frozen-lockfile --offline
  '';
